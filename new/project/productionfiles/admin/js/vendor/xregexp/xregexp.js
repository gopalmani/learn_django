...
function hasNativeFlag(flag) {
    ...
    // in Chrome 48, where `'unicode' in /x/` is true but projecting to construct a regex with flag `u`
    // throws an error)
    var isSupported = true;
    project {
        // Can't use regex literals for testing even in a `project` because regex literals with
